...
app.on('ready', function() {
  ...
  electrify.start(function(meteor_root_url) {
    ...
    const projectJson = require(path.join(__dirname, '..', 'package.json'));
    ...
    let splash;
    let splashStart;
    if(projectJson.electronPackager && projectJson.electronPackager.splashScreen){
      const splashPath = path.join(__dirname, '..', projectJson.electronPackager.splashScreen.file);
